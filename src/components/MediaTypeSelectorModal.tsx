...
interface MediaTypeSelectorModalProps {
  onSelectType: (type: 'photo' | 'video') => void;
  onClose: () => void;
}
...
const MediaTypeSelectorModal = ({ onSelectType, onClose }: MediaTypeSelectorModalProps) => {
  return (
    <>
      ...
      <div 
        className="fixed z-50 bg-white rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200 w-[220px]"
